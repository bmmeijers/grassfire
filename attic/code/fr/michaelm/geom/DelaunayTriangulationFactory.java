 ...
 */
public class DelaunayTriangulationFactory {
   ...
   /** Triangles of the triangulation.*/
    ...
    public static void main(String[] args) {
        ...
        DelaunayTriangulationFactory T = new DelaunayTriangulationFactory(tp, null);
        T.triangulate();
    }
    ...
    */
    public DelaunayTriangulationFactory(Coordinate[] points, int[][] breaklines) {
        try {
  ...
  /** Localise le triangle contenant le point p.
    ...
    */
    public class Triangle {
      ...
      /** Cherche l'indice (0,1 ou 2) du point opposé à ce Triangle dans le Triangle
        * adjacent au coté i-(i+1)
        ...
        */
        ...
        /** Ajoute une contrainte sur un coté et met à jour le triangle
          * adjacent.*/
        ...
        /** Retourne la contrainte sur l coté c*/
       ...
       /**
        * Ce test d'égalité renvoie true si les deux triangles pointent sur
        * sur les mêmes PointT, dans le même ordre.
        * (Tester l'égalité des coordonnées est en effet inutile puisque 2 
        * PointT ne peuvent avoir les mêmes coordonnées).
        */
