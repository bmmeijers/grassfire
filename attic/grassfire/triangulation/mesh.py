...
#        self.delaunay_queue.add(he3)
    ...
    def add_vertex24(self, he1, vertex):
        """Performs insertion of the ``vertex'' in interior of *he1*
...
#        cdef HalfEdge he1, he2, he3, he4
        ...
        he3 = he.sibling.next
        he4 = he3.next
        print "flip", he.origin, he.sibling.origin, "into",
        # flip origins
        he.origin = he2.origin
        he.sibling.origin = he4.origin
        print he.origin, he.sibling.origin
...
class MovingVertex(Vertex):
    ...
    def point_at(self, time):
        return (self.x + self.velocity[0] * (time-self.start),
                self.y + self.velocity[1] * (time-self.start))
...
#        print >> sys.stderr, "setting origin", value, "for", self
        self._origin = value
